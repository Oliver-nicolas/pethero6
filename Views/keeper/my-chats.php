                    ...
                    <div class="py-5">
                        ...
                        <div class="row pl-2 pr-3">
                            ...
                            <div class="col-md-3 col-lg-3 col-xl-3 mb-4 mb-md-0">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="<?= FRONT_ROOT ?>Keeper/NewChat" method="post">
                                            <div class="form-group">
                                                <select class="form-control" name="ownerId" required>
                                                    <?php
                                                    foreach ($owners as $owner) {
                                                    ?>
                                                        <option value="<?= $owner->getId() ?>"><?= $owner ?></option>
                                                    <?php
                                                    } 
                                                    ?>
                                                </select>
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            <?php foreach ($chats as $chat) { ?>
                                                <li class="p-2 border-bottom" <?= $chatId == $chat->getId() ? 'style="background-color: #eee;"' : '' ?>>
                                                    <a href="<?= FRONT_ROOT ?>Keeper/ShowMyChats/<?= $chat->getId() ?>" class="d-flex justify-content-between">
                                                        <div class="d-flex flex-row">
                                                            ...
                                                            <div class="p-1 ">
                                                                <p class="fw-bold mb-0"><?= $chat->getOwner() ?></p>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                            ...
                            <div class="col-md-9 col-lg-9 col-xl-9">
                                ...
                                <?php if ($chatId != null) { ?>
                                    <div class="mb-5">
                                        <form action="<?= FRONT_ROOT ?>Keeper/SendMessage" method="post">
